...
**Explanation:** draw_fusions.R R script for fusion visualization; --fusions=fusions.tsv input fusions file; --alignments=... BAM file; --genome=genome.fa genome FASTA; --annotation=genes.gtf gene annotation; --output=fusion_plots.pdf output PDF; outputs PDF with structural diagrams for each fusion; requires R with ggplot2
