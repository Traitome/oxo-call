...
- Not specifying --modified-bases when the BAM has multiple modification types (e.g., 5mC and 5hmC) reports all types together; filter with --modified-bases h or m.
...
**Args:** `pileup --ref reference.fasta --modified-bases m --cpg input.bam output.bedmethyl --threads 16`
**Explanation:** --modified-bases m selects 5-methylcytosine; --cpg restricts to CpG dinucleotides; --ref required for strand collapsing
...
**Args:** `extract --ref reference.fasta --modified-bases m input.bam per_read_mods.tsv --threads 16`
...
**Args:** `pileup --ref reference.fasta --region chr1:1-10000000 --modified-bases m input.bam region_output.bedmethyl --threads 8`
...
**Args:** `sample-probs --modified-bases m input.bam --threads 8`
...
**Args:** `pileup --ref reference.fasta --filter-threshold 0.7 --modified-bases m input.bam output.bedmethyl --threads 16`
...
**Args:** `extract --ref reference.fasta --motif CG 0 --modified-bases m input.bam cpg_mods.tsv --threads 16`
