...
description: Efficient pileup of known SNPs from single-cell or bulk RNA/DNA-seq BAM files
tags: [single-cell, snp, pileup, allele-specific, genotyping, rna-seq, demultiplexing]
